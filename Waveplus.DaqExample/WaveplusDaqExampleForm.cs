...
namespace Waveplus.DaqExample
{
    public partial class WaveplusDaqExampleForm : Form
    {
        ...
        private void StartCaptureButton_Click(object sender, EventArgs e)
        {
            try
            {
                // Configure sensor 3 as Inertial sensor (accelerometer full scale = 8g; gyroscope full scale = 2000dps)
                ...
                // Configure sensors 1, 2 and from 4 to _installedSensor as EMG sensors (accelerometer full scale = 2g)
